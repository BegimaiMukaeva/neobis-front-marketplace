...
//   const [isDeleteProductModalOpen, setIsDeleteProductModalOpen] = useState(
//     false
//   );
//   const [isEditDeleteButtonsOpen, setIsEditDeleteButtonsOpen] = useState(
//     false
//   );
//   const handleLikeClick = () => {
//     setIsLiked(!isLiked);
//     if (onLikeClick) {
//       onLikeClick(product.id); // Передаем ID товара при нажатии на лайк
//     }
//   };
